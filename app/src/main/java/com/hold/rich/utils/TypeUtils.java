        ...
        while (true) {
            if (toResolve instanceof TypeVariable) {
                ...
                return componentType == newComponentType
                        ? original
                        : new TypeUtils.GenericArrayTypeImpl(newComponentType);
                ...
                return changed
                        ? new TypeUtils.ParameterizedTypeImpl(newOwnerType, original.getRawType(), args)
                        : original;
                ...
                if (originalLowerBound.length == 1) {
                    ...
                    if (lowerBound != originalLowerBound[0]) {
                        return new TypeUtils.WildcardTypeImpl(new Type[]{Object.class}, new Type[]{lowerBound});
                    }
                } else if (originalUpperBound.length == 1) {
                    Type upperBound = resolve(context, contextRawType, originalUpperBound[0]);
                    if (upperBound != originalUpperBound[0]) {
                        return new TypeUtils.WildcardTypeImpl(new Type[]{upperBound}, EMPTY_TYPE_ARRAY);
                    }
                }
                return original;
